...
var lines = {};
  ...
  for(i=0; i<variables.length; i++){
      lines["intheUK"].push({date:variables[i].split("y")[1],amt:+countrydata_allI[0][variables[i]]})
      lines["intheEU"].push({date:variables[i].split("y")[1],amt:+countrydata_allE[0][variables[i]]})
  }
