...
function createBarcode(lastyear){
  ...
  barcodeimports = barcodeimports.filter(function(d){return d.CountryId!="Worlddata" })
  barcodeexports = barcodeexports.filter(function(d){return d.CountryId!="Worlddata" })
